...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /* =====================================================
       8. CATEGORY LINKS / CATEGORY BUTTONS
       Excludes dynamically generated product cards.
    ===================================================== */

    document.querySelectorAll(
        "[data-category]:not(.product-card)"
    ).forEach(button => {
    ...
    /* =====================================================
       9. IMPORTANT:
       PRODUCTS.JS LOAD COMPLETE EVENT
    ===================================================== */
    ...
    document.addEventListener(
        ...
        () => {
            ...
            /*
             * Firebase products are loaded
             * asynchronously by products.js.
             *
             * Apply the selected category
             * again after the products appear.
             */
    ...
    document.addEventListener(
        ...
        event => {
            ...
            const productLink =
                productId
                    ? `${window.location.origin}${window.location.pathname.replace(/[^/]*$/, "")}product.html?id=${encodeURIComponent(productId)}`
